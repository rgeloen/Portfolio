<nav class="nav">
  <div class="hamburger-bloc" onclick="menuToggle(this)">
    <div class="hamburger">
  ...
  <div class="menu-resume">
    ...
    <div class="social">
      ...
      <a href="https://github.com/rgeloen" target="_blank"><i class="fab fa-github fa-2x"></i></a>
      <a href="https://www.behance.net/rgeloen5edc" target="_blank"><i class="fab fa-behance fa-2x"></i></a>
    </div>
  </div>
</nav>
